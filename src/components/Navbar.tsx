...
const productDropdownItems = [
  ...
  { name: "Digicraft Media", href: "https://media.digicraft.one", logo: "https://media.digicraft.one/img/logo.png" },
];
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                ...
                className={`relative group ${isActive(item.path) ? 'text-teal-400' : 'text-gray-300'
                  }`}
              >
                {item.name}
            ...
            <button
              ...
              className="px-4 py-2 rounded-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:shadow-lg hover:shadow-teal-500/25 transition-all"
            >
              Let&apos;s Talk
            </button>
          </div>
            ...
            <div className="px-4 py-6 space-y-4">
              {navItems.map((item) => (
                <Link
                  ...
                  href={item.path}
                  onClick={() => handleNavClick(item.path)}
                  className={`block py-2 ${isActive(item.path) ? 'text-teal-400' : 'text-gray-300'
