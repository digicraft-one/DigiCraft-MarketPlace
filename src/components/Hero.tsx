...
const Hero = () => {
    ...
    return (
        <div
            ref={sectionRef}
            className="h-screen relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-black">
            <GradientBlob />
            <FloatingParticles />
            ...
            <div className="relative z-10 h-full flex items-center justify-center">
                <div className="text-center max-w-5xl px-4" ref={textRef}>
                    ...
                    <motion.h1
                        className="text-6xl md:text-8xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-500 font-roboto-slab"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.p
                        ...
                        Save time and money with professional, pre-built assets
                        crafted for instant deployment and easy customization.
                    </motion.p>
