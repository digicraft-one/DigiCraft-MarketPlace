...
const platforms = [
    {
        ...
        icon: GlobeAltIcon,
        description:
            "Responsive web applications that work seamlessly across all browsers and devices.",
        features: [
    ...
    },
    {
        ...
        description:
            "Native Android applications built with modern development practices.",
        features: [
            "Material Design UI",
    ...
    },
    {
        ...
        description:
            "Premium iOS applications designed for iPhone and iPad users.",
        features: [
            ...
            <div className="max-w-7xl mx-auto relative">
                <motion.div
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto">
                        From web applications to mobile apps, we create
                        solutions for every platform. Your business deserves to
                ...
                <motion.div
                    ...
                    <div className="bg-gradient-to-r from-slate-900/50 to-transparent backdrop-blur-sm border border-teal-500/20 rounded-2xl p-8">
                        ...
                        <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
                            ...
                            specific platforms and requirements. Let's discuss
                            your unique needs and create a tailored solution.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                href={"https://www.digicraft.one/pricing"}
                                target="_blank">
                                <button className="cursor-pointer px-8 py-4 bg-gradient-to-r from-teal-500 to-blue-500 rounded-full text-white font-semibold hover:shadow-lg hover:shadow-teal-500/25 transition-all">
                                    Get Custom Quote
                                </button>
                            </Link>
                            <Link href={"https://www.digicraft.one/contact"} target="_blank ">
                                <button className="cursor-pointer px-8 py-4 border border-teal-400 rounded-full text-teal-400 font-semibold hover:bg-teal-500/10 transition-all">
