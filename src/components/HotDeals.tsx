...
import { ArrowRightIcon, FireIcon, ClockIcon } from '@heroicons/react/24/outline'
...
const HotDealCard = ({ title, originalPrice, discountedPrice, discount, image, features, timeLeft, category, index }: HotDealCardProps) => (
  <motion.div
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Limited time offers on our most popular pre-built websites. 
            Don't miss out on these incredible discounts!
          </p>
        </motion.div>
